...
# sample_source=data\experiments\xdc_sampler_island\random1_sample_ro_local_x45y39.xdc
...
set_property LOC SLICE_X45Y39 [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_NAND.u_LUT6_nand2_1/u_LUT6}]
set_property BEL A6LUT [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_NAND.u_LUT6_nand2_1/u_LUT6}]
set_property LOC SLICE_X45Y39 [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[0].u_LUT6_not1/u_LUT6}]
set_property BEL B6LUT [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[0].u_LUT6_not1/u_LUT6}]
set_property LOC SLICE_X45Y39 [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[1].u_LUT6_not1/u_LUT6}]
set_property BEL C6LUT [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[1].u_LUT6_not1/u_LUT6}]
set_property LOC SLICE_X45Y39 [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[2].u_LUT6_not1/u_LUT6}]
set_property BEL D6LUT [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[2].u_LUT6_not1/u_LUT6}]
set_property LOC SLICE_X46Y39 [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[3].u_LUT6_not1/u_LUT6}]
set_property BEL A6LUT [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[3].u_LUT6_not1/u_LUT6}]
set_property LOC SLICE_X46Y39 [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[4].u_LUT6_not1/u_LUT6}]
set_property BEL B6LUT [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[4].u_LUT6_not1/u_LUT6}]
set_property LOC SLICE_X46Y39 [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[5].u_LUT6_not1/u_LUT6}]
set_property BEL C6LUT [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[5].u_LUT6_not1/u_LUT6}]
set_property LOC SLICE_X46Y39 [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[6].u_LUT6_not1/u_LUT6}]
set_property BEL D6LUT [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[6].u_LUT6_not1/u_LUT6}]
set_property LOC SLICE_X47Y39 [get_cells -hierarchical -filter {NAME =~ *u_ro_matrix/RO_SAMPLE_LOOP[7].u_LUT6_not1/u_LUT6}]
