...
# label=tdc_sampler_data_random3_sample_x36y35_ro3
# family=random3
# source_matrix_xdc=data/experiments/xdc_matrix/ro_random_seed3_x36y35.xdc
# u_ro_a=sample_ro_x36y35; u_ro_b=data_ro3
...
# u_ro_b <= data RO3, expected RO_STAGES=2
set_property LOC SLICE_X66Y51 [get_cells -hierarchical -filter {NAME =~ *u_ro_b/RO_AND.u_LUT6_and2_1/u_LUT6}]
set_property BEL C6LUT [get_cells -hierarchical -filter {NAME =~ *u_ro_b/RO_AND.u_LUT6_and2_1/u_LUT6}]
set_property LOC SLICE_X66Y51 [get_cells -hierarchical -filter {NAME =~ *u_ro_b/RO_STAGE_LOOP[0].u_LUT6_not1/u_LUT6}]
