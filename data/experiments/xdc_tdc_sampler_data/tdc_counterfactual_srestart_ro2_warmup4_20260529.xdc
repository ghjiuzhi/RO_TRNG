...
# label=tdc_counterfactual_srestart_ro2_warmup4_20260529
# u_ro_a=Srestart sample RO lock from formal auto W4
# u_ro_b=data_ro2 from random1 matrix
...
# u_ro_b <= data RO2 from random1 matrix, expected RO_STAGES=2
set_property LOC SLICE_X67Y63 [get_cells -hierarchical -filter {NAME =~ *u_ro_b/RO_AND.u_LUT6_and2_1/u_LUT6}]
set_property BEL A6LUT [get_cells -hierarchical -filter {NAME =~ *u_ro_b/RO_AND.u_LUT6_and2_1/u_LUT6}]
set_property LOC SLICE_X67Y63 [get_cells -hierarchical -filter {NAME =~ *u_ro_b/RO_STAGE_LOOP[0].u_LUT6_not1/u_LUT6}]
