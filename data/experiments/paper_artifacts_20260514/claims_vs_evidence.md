...
| Repeat captures are broadly consistent at placement level | table_placement_trng_repeats.csv/md | max formal-repeat bit_min_entropy_mean delta=0.000770577 | supported for available repeats | some placements have repeat-only rows and are excluded from paired delta |
