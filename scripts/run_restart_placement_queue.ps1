param(
    [string]$QueueCsv = "data\experiments\fast_mode\restart_placement_queue_20260515.csv",
    [string]$Port = "COM3",
    [int]$Baud = 115200,
    ...
    [string]$ArtifactRoot = "data\experiments\paper_artifacts_20260515",
    [string]$LogDir = "data\experiments\restart_placement_logs_20260515",
    [switch]$RecordXadc,
    [string]$XadcCsv = "",
...
foreach ($row in $rows) {
    ...
    $eaMsbRun = "${placement}_warmup${warmup}_${repeatTag}_msb_20260515"
    $eaLsbRun = "${placement}_warmup${warmup}_${repeatTag}_lsb_20260515"
    $eaMsbDir = Join-Path $restartDir "ea_restart_${placement}_warmup${warmup}_${repeatTag}_msb_20260515"
    $eaLsbDir = Join-Path $restartDir "ea_restart_${placement}_warmup${warmup}_${repeatTag}_lsb_20260515"
    ...
    try {
        ...
        Write-Warning "Restart placement row failed: $errorMessage"
...
$summaryPath = Join-Path $logDirAbs "restart_placement_queue_summary_20260515.json"
